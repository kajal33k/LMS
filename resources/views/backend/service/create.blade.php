<x-layouts.app :title="__('Service')">
    <div class="max-w-2xl mx-auto mt-10 p-6 bg-black shadow-xl rounded-2xl">
        ...
        <form action="{{ route('backend.service.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div>
                <label for="image" class="block text-sm font-medium text-white">service Image</label>
