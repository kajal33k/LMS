...
<div class="max-w-2xl mx-auto mt-10 p-6 bg-black shadow-xl rounded-2xl">
    <h2 class="text-2xl font-semibold text-white mb-6">Create New Banner</h2>
    ...
    <form action="{{ route('backend.banner.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
